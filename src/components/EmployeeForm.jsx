    ...
    return (
        <div className='container'>
            ...
            <div className="d-flex my-5 justify-content-between">
                <button type="button" className="btn btn-outline-success" onClick={() => navigate("/")}>Back</button>
            ...
            <div className="card border-primary ">
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        <label className="form-label mt-1" htmlFor="inputValid">Name</label>
                        <input
                            name="name"
                            type="text"
                    ...
                    <div className="form-group">
                        <label className="form-label mt-1" htmlFor="inputValid">Email</label>
                        <input
                            name="email"
                            type="email"
                    ...
                    <div className="form-group">
                        <label className="form-label mt-1" htmlFor="inputValid">Address</label>
                        <input
                            type="text"
                            name="address"
                    ...
                    <div className="form-group">
                        <label className="form-label mt-1" htmlFor="inputValid">Phone</label>
                        <input
                            name="phone"
                            type="text" required
